...
class Category(models.Model):
    cid = ShortUUIDField(unique=True, length=10, max_length=20, prefix="cat_", alphabet="abcdefg1234",)
...
class Product(models.Model):
    pid = ShortUUIDField(unique=True, length=10, max_length=20, prefix="prd_", alphabet="abcdefg1234",)
    ...
    stock_count = models.CharField(choices=STATUS, max_length=10, default="10",blank=True)
...
class ProductImages(models.Model):
    ...
    product = models.ForeignKey(Product, related_name="p_image", max_length=100, on_delete=models.SET_NULL, null=True)
    date = models.DateTimeField(auto_now_add=True)
...
class CartOrderItems(models.Model):
    order = models.ForeignKey(CartOrder,  max_length=100, on_delete=models.CASCADE, null=True)
    invoice_no = models.CharField(max_length=200)
    product_status = models.CharField(max_length=200,default=True)
    item = models.CharField(max_length=200)
    image = models.CharField(max_length=200)
    qty = models.IntegerField(default=0)
    price = models.DecimalField(max_digits=9999999, decimal_places=2, default="20")
    total = models.DecimalField(max_digits=9999999, decimal_places=2, default="20")
