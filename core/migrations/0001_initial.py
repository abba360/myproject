# Generated by Django 4.2.9 on 2024-02-09 20:46
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('product_status', models.CharField(choices=[('process', 'Processing'), ('shipped', 'Shipped'), ('Delivered', 'Delivered')], default='In Review', max_length=10)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date', models.DateTimeField(auto_now_add=True)),
                ('product', models.ForeignKey(max_length=100, null=True, on_delete=django.db.models.deletion.SET_NULL, to='core.product')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('product_status', models.CharField(default=True, max_length=200)),
                ('item', models.CharField(max_length=200)),
                ('image', models.CharField(max_length=200)),
                ('qty', models.IntegerField(default=0)),
                ('price', models.DecimalField(decimal_places=2, default='20', max_digits=9999999)),
                ('total', models.DecimalField(decimal_places=2, default='20', max_digits=9999999)),
                ('order', models.ForeignKey(max_length=100, null=True, on_delete=django.db.models.deletion.CASCADE, to='core.cartorder')),
            ],
            options={
